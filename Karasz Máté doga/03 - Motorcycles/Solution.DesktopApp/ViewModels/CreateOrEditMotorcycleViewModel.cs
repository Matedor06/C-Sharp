    ...
    IGoogleDriveService googleDriveService) : MotorcycleModel(), IQueryAttributable
{
    ...
    public IRelayCommand MotorcycleTypeIndexChangedCommand => new RelayCommand(() => this.MotorcycleType.Validate());
    #endregion
    ...
    [ObservableProperty]
    private IList<MotorcycleTypeModel> motorcycleTypes = [];
    ...
    public async void ApplyQueryAttributes(IDictionary<string, object> query)
    {
        ...
        await Task.Run(() => LoadMotorcycleTypesAsync());
        ...
        this.MotorcycleType.Value = motorcycle.MotorcycleType.Value;
    ...
    private async Task LoadMotorcycleTypesAsync()
    {
        MotorcycleTypes = await dbContext.Types.AsNoTracking()
                                                         .OrderBy(x => x.Name)
                                                         .Select(x => new MotorcycleTypeModel(x))
                                                         .ToListAsync();
    }
