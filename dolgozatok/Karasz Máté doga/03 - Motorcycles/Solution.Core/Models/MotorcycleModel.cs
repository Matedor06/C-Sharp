...
public partial class MotorcycleModel
{
    ...
    public ValidatableObject<MotorcycleTypeModel> MotorcycleType { get; set; }
    ...
    public MotorcycleModel()
    {
        ...
        this.MotorcycleType = new ValidatableObject<MotorcycleTypeModel>();
    ...
    public MotorcycleModel(MotorcycleEntity entity): this()
    {
        ...
        this.MotorcycleType.Value = new MotorcycleTypeModel(entity.Type);
    ...
    public MotorcycleEntity ToEntity()
    {
        return new MotorcycleEntity
        {
            ...
            TypeId = MotorcycleType.Value.Id,
            Model = Model.Value,
            Cubic = Cubic.Value ?? 0,
    ...
    public void ToEntity(MotorcycleEntity entity)
    {
        ...
        entity.TypeId = MotorcycleType.Value.Id;
    ...
    private void AddValidators()
    {
        ...
        this.MotorcycleType.Validations.Add(new PickerValidationRule<MotorcycleTypeModel>
        {
            ValidationMessage = "MotorcycleType must be selected"
        });
